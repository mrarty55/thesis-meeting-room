...
export default {
  ...
  computed: {
    name: {
      get() {
        return this.$store.state.public.quotation.name
      },
      set(value) {
        this.$store.commit('public/quotation/name', value)
      },
    },
    email: {
      get() {
        return this.$store.state.public.quotation.email
      },
      set(value) {
        this.$store.commit('public/quotation/email', value)
      },
    },
    phoneNumber: {
      get() {
        return this.$store.state.public.quotation.phoneNumber
      },
      set(value) {
        this.$store.commit('public/quotation/phoneNumber', value)
      },
    },
    occupation: {
      get() {
        return this.$store.state.public.quotation.occupation
      },
      set(value) {
        this.$store.commit('public/quotation/occupation', value)
      },
    },
    eventTitle: {
      get() {
        return this.$store.state.public.quotation.eventTitle
      },
      set(value) {
        this.$store.commit('public/quotation/title', value)
      },
    },
    eventType: {
      get() {
        return this.$store.state.public.quotation.eventType
      },
      set(value) {
        this.$store.commit('public/quotation/type', value)
      },
    },
    eventStatus: {
      get() {
        return this.$store.state.public.quotation.eventStatus
      },
      set(value) {
        this.$store.commit('public/quotation/status', value)
      },
    },
    eventDate: {
      get() {
        return this.$store.state.public.quotation.eventDate
      },
      set(value) {
        this.$store.commit('public/quotation/date', value)
      },
    },
    eventStartTime: {
      get() {
        return this.$store.state.public.quotation.eventStartTime
      },
      set(value) {
        this.$store.commit('public/quotation/start', value)
      },
    },
    eventEndTime: {
      get() {
        return this.$store.state.public.quotation.eventEndTime
      },
      set(value) {
        this.$store.commit('public/quotation/end', value)
      },
    },
    rooms: {
      get() {
        return this.$store.state.public.quotation.rooms
      },
      set(value) {
        this.$store.commit('public/quotation/rooms', value)
      },
    },
    roomStyle: {
      get() {
        return this.$store.state.public.quotation.roomStyle
      },
      set(value) {
        this.$store.commit('public/quotation/style', value)
      },
    },
    equipments: {
      get() {
        return this.$store.state.public.quotation.equipments
      },
      set(value) {
        this.$store.commit('public/quotation/equipments', value)
      },
    },
    drinks: {
      get() {
        return this.$store.state.public.quotation.drinks
      },
      set(value) {
        this.$store.commit('public/quotation/drinks', value)
      },
    },
    nameErrors() {
      const errors = []
      if (!this.$v.name.$dirty) return
      !this.$v.name.required && errors.push('ກະລຸນາປ້ອນຊື່ແລະນາມສະກຸນ')
      return errors
    },
    emailErrors() {
      const errors = []
    ...
    phoneNumberErrors() {
      const errors = []
      if (!this.$v.phoneNumber.$dirty) return
  ...
  methods: {
    onReview() {
      ...
      this.$store.dispatch('public/quotation/review')
    },
    onClear() {
      this.$v.$reset()
      this.$store.commit('public/quotation/clear')
    },
  },
}
</script>
